"""
Django settings for skadi_45307 project.
...
WSGI_APPLICATION = 'skadi_45307.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "skadi_45307 API",
    "DESCRIPTION": "API documentation for skadi_45307 App",
    "VERSION": "v1",
}
